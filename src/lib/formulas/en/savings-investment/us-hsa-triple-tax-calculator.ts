...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"HSA\" (Health Savings Account) Triple Tax Advantage Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:savings-&-investment/us-hsa-triple-tax-calculator",
  slug: "savings-&-investment/us-hsa-triple-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US \"HSA\" (Health Savings Account) Triple Tax Advantage Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
