...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"LIRA\" (Locked-In Retirement Account) Unlocking Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:savings-&-investment/canada-lira-unlocking-calculator",
  slug: "savings-&-investment/canada-lira-unlocking-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"LIRA\" (Locked-In Retirement Account) Unlocking Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
