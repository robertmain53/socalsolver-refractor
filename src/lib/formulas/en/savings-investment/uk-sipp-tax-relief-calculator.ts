...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"SIPP\" (Self-Invested Personal Pension) Tax Relief Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:savings-&-investment/uk-sipp-tax-relief-calculator",
  slug: "savings-&-investment/uk-sipp-tax-relief-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"SIPP\" (Self-Invested Personal Pension) Tax Relief Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
