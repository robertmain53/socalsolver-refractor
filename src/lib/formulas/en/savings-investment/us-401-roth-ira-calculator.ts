...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US 401(k) vs. Roth IRA Contribution Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:savings-&-investment/us-401-roth-ira-calculator",
  slug: "savings-&-investment/us-401-roth-ira-calculator",
  ...
  faq: [
    { q: "How do I use the US 401(k) vs. Roth IRA Contribution Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
