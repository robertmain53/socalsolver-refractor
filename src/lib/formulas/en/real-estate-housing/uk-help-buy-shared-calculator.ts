...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Help to Buy\" vs. \"Shared Ownership\" Scheme Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:real-estate-&-housing/uk-help-buy-shared-calculator",
  slug: "real-estate-&-housing/uk-help-buy-shared-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Help to Buy\" vs. \"Shared Ownership\" Scheme Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
