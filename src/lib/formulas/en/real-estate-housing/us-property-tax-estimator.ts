...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US Property Tax Estimator (by state and county)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:real-estate-&-housing/us-property-tax-estimator",
  slug: "real-estate-&-housing/us-property-tax-estimator",
  ...
  faq: [
    { q: "How do I use the US Property Tax Estimator (by state and county) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
