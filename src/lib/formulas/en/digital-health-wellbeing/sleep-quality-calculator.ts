...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Sleep Quality Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:digital-health-&-wellbeing/sleep-quality-calculator",
  slug: "digital-health-&-wellbeing/sleep-quality-calculator",
  ...
  faq: [
    { q: "How do I use the Sleep Quality Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
