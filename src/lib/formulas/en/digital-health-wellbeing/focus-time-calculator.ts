...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Focus Time Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:digital-health-&-wellbeing/focus-time-calculator",
  slug: "digital-health-&-wellbeing/focus-time-calculator",
  ...
  faq: [
    { q: "How do I use the Focus Time Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
