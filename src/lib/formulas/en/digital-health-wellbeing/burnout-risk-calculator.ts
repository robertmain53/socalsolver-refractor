...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Burnout Risk Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:digital-health-&-wellbeing/burnout-risk-calculator",
  slug: "digital-health-&-wellbeing/burnout-risk-calculator",
  ...
  faq: [
    { q: "How do I use the Burnout Risk Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
