...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Digital Detox Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:digital-health-&-wellbeing/digital-detox-calculator",
  slug: "digital-health-&-wellbeing/digital-detox-calculator",
  ...
  faq: [
    { q: "How do I use the Digital Detox Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
