...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Work-Life Balance Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:digital-health-&-wellbeing/work-life-balance-calculator",
  slug: "digital-health-&-wellbeing/work-life-balance-calculator",
  ...
  faq: [
    { q: "How do I use the Work-Life Balance Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
