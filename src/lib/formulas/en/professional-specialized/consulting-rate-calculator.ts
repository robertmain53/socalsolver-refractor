...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Consulting Rate Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/consulting-rate-calculator",
  slug: "professional-&-specialized/consulting-rate-calculator",
  ...
  faq: [
    { q: "How do I use the Consulting Rate Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
