...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Translation Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/translation-cost-calculator",
  slug: "professional-&-specialized/translation-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Translation Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
