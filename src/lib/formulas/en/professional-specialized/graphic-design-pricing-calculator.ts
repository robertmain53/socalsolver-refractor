...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Graphic Design Pricing Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/graphic-design-pricing-calculator",
  slug: "professional-&-specialized/graphic-design-pricing-calculator",
  ...
  faq: [
    { q: "How do I use the Graphic Design Pricing Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
