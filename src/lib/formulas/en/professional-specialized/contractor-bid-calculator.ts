...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Contractor Bid Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/contractor-bid-calculator",
  slug: "professional-&-specialized/contractor-bid-calculator",
  ...
  faq: [
    { q: "How do I use the Contractor Bid Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
