...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Legal Fee Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/legal-fee-calculator",
  slug: "professional-&-specialized/legal-fee-calculator",
  ...
  faq: [
    { q: "How do I use the Legal Fee Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
