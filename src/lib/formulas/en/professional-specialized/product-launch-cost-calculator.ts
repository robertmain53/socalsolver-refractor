...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Product Launch Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:professional-&-specialized/product-launch-cost-calculator",
  slug: "professional-&-specialized/product-launch-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Product Launch Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
