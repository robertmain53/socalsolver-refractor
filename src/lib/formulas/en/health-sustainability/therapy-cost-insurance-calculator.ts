...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Therapy/Counseling Cost & Insurance Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/therapy-cost-insurance-calculator",
  slug: "health-&-sustainability/therapy-cost-insurance-calculator",
  ...
  faq: [
    { q: "How do I use the Therapy/Counseling Cost & Insurance Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
