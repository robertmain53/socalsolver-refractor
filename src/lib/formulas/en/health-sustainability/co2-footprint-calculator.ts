...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "CO2 Footprint Calculator (travel, diet, energy)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/co2-footprint-calculator",
  slug: "health-&-sustainability/co2-footprint-calculator",
  ...
  faq: [
    { q: "How do I use the CO2 Footprint Calculator (travel, diet, energy) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
