...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Bicycle Commuting Savings Calculator (fuel, maintenance, health)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/bicycle-commuting-savings-calculator",
  slug: "health-&-sustainability/bicycle-commuting-savings-calculator",
  ...
  faq: [
    { q: "How do I use the Bicycle Commuting Savings Calculator (fuel, maintenance, health) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
