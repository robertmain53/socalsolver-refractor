...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "IVF Treatment Cost Estimator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/ivf-treatment-cost-calculator",
  slug: "health-&-sustainability/ivf-treatment-cost-calculator",
  ...
  faq: [
    { q: "How do I use the IVF Treatment Cost Estimator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
