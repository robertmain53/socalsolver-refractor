...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Elder Care Cost Calculator (in-home vs. facility)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/elder-care-cost-calculator",
  slug: "health-&-sustainability/elder-care-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Elder Care Cost Calculator (in-home vs. facility) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
