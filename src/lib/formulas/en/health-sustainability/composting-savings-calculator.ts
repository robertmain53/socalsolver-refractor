...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Composting Waste Reduction & Savings Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/composting-savings-calculator",
  slug: "health-&-sustainability/composting-savings-calculator",
  ...
  faq: [
    { q: "How do I use the Composting Waste Reduction & Savings Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
