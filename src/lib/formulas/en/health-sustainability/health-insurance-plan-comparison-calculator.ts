...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Health Insurance Plan Comparison Calculator (deductible, premium, out-of-pocket max)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/health-insurance-plan-comparison-calculator",
  slug: "health-&-sustainability/health-insurance-plan-comparison-calculator",
  ...
  faq: [
    { q: "How do I use the Health Insurance Plan Comparison Calculator (deductible, premium, out-of-pocket max) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
