...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Solar Panel Installation ROI Calculator (incl. local incentives)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:health-&-sustainability/solar-panel-roi-calculator",
  slug: "health-&-sustainability/solar-panel-roi-calculator",
  ...
  faq: [
    { q: "How do I use the Solar Panel Installation ROI Calculator (incl. local incentives) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
