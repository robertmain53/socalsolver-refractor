...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US Self-Employment Tax Calculator (Schedule C & SE Tax)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-self-employment-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-self-employment-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US Self-Employment Tax Calculator (Schedule C & SE Tax) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
