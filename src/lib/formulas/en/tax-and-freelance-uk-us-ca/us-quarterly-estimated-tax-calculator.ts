...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US Quarterly Estimated Tax Calculator (Form 1040-ES)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-quarterly-estimated-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-quarterly-estimated-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US Quarterly Estimated Tax Calculator (Form 1040-ES) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
