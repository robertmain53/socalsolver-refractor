...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Qualified Dividends\" vs. \"Ordinary Dividends\" Tax Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-qualified-dividends-ordinary-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-qualified-dividends-ordinary-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Qualified Dividends\" vs. \"Ordinary Dividends\" Tax Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
