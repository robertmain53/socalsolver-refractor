...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Payment on Account\" Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/uk-payment-account-calculator",
  slug: "tax-and-freelance-uk-us-ca/uk-payment-account-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Payment on Account\" Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
