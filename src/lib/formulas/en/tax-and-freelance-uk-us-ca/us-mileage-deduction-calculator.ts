...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Mileage Deduction\" Calculator (standard vs. actual)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-mileage-deduction-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-mileage-deduction-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Mileage Deduction\" Calculator (standard vs. actual) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
