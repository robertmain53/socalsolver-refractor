...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK IR35 \"Deemed Salary\" Calculator for Contractors"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/uk-ir35-deemed-salary-calculator",
  slug: "tax-and-freelance-uk-us-ca/uk-ir35-deemed-salary-calculator",
  ...
  faq: [
    { q: "How do I use the UK IR35 \"Deemed Salary\" Calculator for Contractors calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
