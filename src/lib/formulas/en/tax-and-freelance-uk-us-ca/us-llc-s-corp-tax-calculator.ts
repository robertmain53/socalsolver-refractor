...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US LLC vs. S-Corp Tax Savings Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-llc-s-corp-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-llc-s-corp-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US LLC vs. S-Corp Tax Savings Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
