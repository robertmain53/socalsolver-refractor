...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US State Income Tax Calculator (comparison across states)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-state-income-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-state-income-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US State Income Tax Calculator (comparison across states) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
