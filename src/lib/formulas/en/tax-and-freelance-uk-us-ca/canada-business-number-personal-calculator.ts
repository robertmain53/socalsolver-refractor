...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada Business Number (BN) vs. Personal Tax Number Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/canada-business-number-personal-calculator",
  slug: "tax-and-freelance-uk-us-ca/canada-business-number-personal-calculator",
  ...
  faq: [
    { q: "How do I use the Canada Business Number (BN) vs. Personal Tax Number Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
