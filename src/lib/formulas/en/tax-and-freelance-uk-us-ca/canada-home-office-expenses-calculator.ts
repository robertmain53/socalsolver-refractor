...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"Home Office Expenses\" Calculator for Employees/Self-Employed"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/canada-home-office-expenses-calculator",
  slug: "tax-and-freelance-uk-us-ca/canada-home-office-expenses-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"Home Office Expenses\" Calculator for Employees/Self-Employed calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
