...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK Self-Assessment Tax Calculator (Income Tax & Class 2/4 NI)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/uk-self-assessment-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/uk-self-assessment-tax-calculator",
  ...
  faq: [
    { q: "How do I use the UK Self-Assessment Tax Calculator (Income Tax & Class 2/4 NI) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
