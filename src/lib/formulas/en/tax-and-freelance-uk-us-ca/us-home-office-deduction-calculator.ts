...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Home Office Deduction\" Calculator (simplified vs. actual expense)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-home-office-deduction-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-home-office-deduction-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Home Office Deduction\" Calculator (simplified vs. actual expense) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
