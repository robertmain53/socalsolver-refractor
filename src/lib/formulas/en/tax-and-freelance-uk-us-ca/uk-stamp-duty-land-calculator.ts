...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK Stamp Duty Land Tax (SDLT) Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/uk-stamp-duty-land-calculator",
  slug: "tax-and-freelance-uk-us-ca/uk-stamp-duty-land-calculator",
  ...
  faq: [
    { q: "How do I use the UK Stamp Duty Land Tax (SDLT) Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
