...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Dividend Tax\" Calculator (for company directors)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/uk-dividend-tax-calculator",
  slug: "tax-and-freelance-uk-us-ca/uk-dividend-tax-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Dividend Tax\" Calculator (for company directors) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
