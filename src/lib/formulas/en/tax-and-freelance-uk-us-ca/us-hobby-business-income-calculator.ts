...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Hobby vs. Business\" Income Tax Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:tax-and-freelance-uk-us-ca/us-hobby-business-income-calculator",
  slug: "tax-and-freelance-uk-us-ca/us-hobby-business-income-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Hobby vs. Business\" Income Tax Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
