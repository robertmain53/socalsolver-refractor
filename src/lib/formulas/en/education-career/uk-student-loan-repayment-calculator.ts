...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Student Loan Repayment\" Calculator (Plan 1, 2, 4, 5 & Postgraduate)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:education-&-career/uk-student-loan-repayment-calculator",
  slug: "education-&-career/uk-student-loan-repayment-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Student Loan Repayment\" Calculator (Plan 1, 2, 4, 5 & Postgraduate) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
