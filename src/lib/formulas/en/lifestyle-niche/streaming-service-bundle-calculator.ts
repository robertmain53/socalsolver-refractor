...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Streaming Service Bundle Cost Optimizer"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/streaming-service-bundle-calculator",
  slug: "lifestyle-&-niche/streaming-service-bundle-calculator",
  ...
  faq: [
    { q: "How do I use the Streaming Service Bundle Cost Optimizer calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
