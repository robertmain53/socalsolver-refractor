...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Zero-Waste Lifestyle Savings Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/zero-waste-savings-calculator",
  slug: "lifestyle-&-niche/zero-waste-savings-calculator",
  ...
  faq: [
    { q: "How do I use the Zero-Waste Lifestyle Savings Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
