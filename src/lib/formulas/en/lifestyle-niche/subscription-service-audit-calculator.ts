...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Subscription Service Audit & Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/subscription-service-audit-calculator",
  slug: "lifestyle-&-niche/subscription-service-audit-calculator",
  ...
  faq: [
    { q: "How do I use the Subscription Service Audit & Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
