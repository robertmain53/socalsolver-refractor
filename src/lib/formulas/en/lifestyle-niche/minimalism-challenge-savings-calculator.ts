...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Minimalism Challenge Savings Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/minimalism-challenge-savings-calculator",
  slug: "lifestyle-&-niche/minimalism-challenge-savings-calculator",
  ...
  faq: [
    { q: "How do I use the Minimalism Challenge Savings Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
