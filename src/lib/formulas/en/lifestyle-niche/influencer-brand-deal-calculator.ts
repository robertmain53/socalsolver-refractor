...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Influencer Brand Deal Rate Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/influencer-brand-deal-calculator",
  slug: "lifestyle-&-niche/influencer-brand-deal-calculator",
  ...
  faq: [
    { q: "How do I use the Influencer Brand Deal Rate Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
