...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Cost of Living Comparison Calculator (City A vs. City B)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/cost-of-living-comparison-calculator",
  slug: "lifestyle-&-niche/cost-of-living-comparison-calculator",
  ...
  faq: [
    { q: "How do I use the Cost of Living Comparison Calculator (City A vs. City B) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
