...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Coffee Shop Spending Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/coffee-shop-spending-calculator",
  slug: "lifestyle-&-niche/coffee-shop-spending-calculator",
  ...
  faq: [
    { q: "How do I use the Coffee Shop Spending Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
