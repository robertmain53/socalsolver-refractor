...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Brewing Your Own Beer Cost vs. Buying Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/brew-your-own-beer-cost-calculator",
  slug: "lifestyle-&-niche/brew-your-own-beer-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Brewing Your Own Beer Cost vs. Buying Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
