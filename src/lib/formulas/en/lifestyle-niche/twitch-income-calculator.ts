...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Twitch Streamer Income Calculator (subs, bits, ads)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/twitch-income-calculator",
  slug: "lifestyle-&-niche/twitch-income-calculator",
  ...
  faq: [
    { q: "How do I use the Twitch Streamer Income Calculator (subs, bits, ads) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
