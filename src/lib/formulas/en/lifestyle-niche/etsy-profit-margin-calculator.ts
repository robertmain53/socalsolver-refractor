...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Etsy Seller Profit Margin Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/etsy-profit-margin-calculator",
  slug: "lifestyle-&-niche/etsy-profit-margin-calculator",
  ...
  faq: [
    { q: "How do I use the Etsy Seller Profit Margin Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
