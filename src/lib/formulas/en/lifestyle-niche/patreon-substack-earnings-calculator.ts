...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Patreon/Substack Creator Earnings Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/patreon-substack-earnings-calculator",
  slug: "lifestyle-&-niche/patreon-substack-earnings-calculator",
  ...
  faq: [
    { q: "How do I use the Patreon/Substack Creator Earnings Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
