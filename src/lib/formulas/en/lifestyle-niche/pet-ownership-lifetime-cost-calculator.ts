...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Pet Ownership Lifetime Cost Calculator (by breed/country)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/pet-ownership-lifetime-cost-calculator",
  slug: "lifestyle-&-niche/pet-ownership-lifetime-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Pet Ownership Lifetime Cost Calculator (by breed/country) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
