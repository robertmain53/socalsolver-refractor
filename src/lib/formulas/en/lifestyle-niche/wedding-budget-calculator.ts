...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Wedding Budget Calculator (by location/guest count)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/wedding-budget-calculator",
  slug: "lifestyle-&-niche/wedding-budget-calculator",
  ...
  faq: [
    { q: "How do I use the Wedding Budget Calculator (by location/guest count) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
