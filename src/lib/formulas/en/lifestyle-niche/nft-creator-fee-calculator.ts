...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "NFT Creator Gas Fee & Royalty Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/nft-creator-fee-calculator",
  slug: "lifestyle-&-niche/nft-creator-fee-calculator",
  ...
  faq: [
    { q: "How do I use the NFT Creator Gas Fee & Royalty Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
