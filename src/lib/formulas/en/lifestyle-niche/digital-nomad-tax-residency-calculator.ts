...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Digital Nomad Tax Residency Calculator (183-day rule tracker)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/digital-nomad-tax-residency-calculator",
  slug: "lifestyle-&-niche/digital-nomad-tax-residency-calculator",
  ...
  faq: [
    { q: "How do I use the Digital Nomad Tax Residency Calculator (183-day rule tracker) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
