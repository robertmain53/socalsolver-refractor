...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Gym Membership vs. \"Home Gym\" Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/gym-membership-home-gym-calculator",
  slug: "lifestyle-&-niche/gym-membership-home-gym-calculator",
  ...
  faq: [
    { q: "How do I use the Gym Membership vs. \"Home Gym\" Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
