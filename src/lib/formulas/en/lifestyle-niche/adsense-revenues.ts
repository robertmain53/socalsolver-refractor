...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "YouTube AdSense Revenue Estimator (by niche/CPM)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/adsense-revenues",
  slug: "lifestyle-&-niche/adsense-revenues",
  ...
  faq: [
    { q: "How do I use the YouTube AdSense Revenue Estimator (by niche/CPM) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
