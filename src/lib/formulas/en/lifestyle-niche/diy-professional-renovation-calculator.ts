...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "DIY vs. Professional Home Renovation Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/diy-professional-renovation-calculator",
  slug: "lifestyle-&-niche/diy-professional-renovation-calculator",
  ...
  faq: [
    { q: "How do I use the DIY vs. Professional Home Renovation Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
