...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Podcast Sponsorship Rate Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/podcast-sponsorship-rate-calculator",
  slug: "lifestyle-&-niche/podcast-sponsorship-rate-calculator",
  ...
  faq: [
    { q: "How do I use the Podcast Sponsorship Rate Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
