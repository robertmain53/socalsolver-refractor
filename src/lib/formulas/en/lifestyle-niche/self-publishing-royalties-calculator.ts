...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Self-Publishing (KDP) Royalties Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/self-publishing-royalties-calculator",
  slug: "lifestyle-&-niche/self-publishing-royalties-calculator",
  ...
  faq: [
    { q: "How do I use the Self-Publishing (KDP) Royalties Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
