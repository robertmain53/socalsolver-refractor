...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Fast Fashion Environmental & Financial Cost Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:lifestyle-&-niche/fast-fashion-cost-calculator",
  slug: "lifestyle-&-niche/fast-fashion-cost-calculator",
  ...
  faq: [
    { q: "How do I use the Fast Fashion Environmental & Financial Cost Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
