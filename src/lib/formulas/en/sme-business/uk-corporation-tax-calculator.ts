...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Corporation Tax\" Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/uk-corporation-tax-calculator",
  slug: "sme-&-business/uk-corporation-tax-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Corporation Tax\" Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
