...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Business Rates\" Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/uk-business-rates-calculator",
  slug: "sme-&-business/uk-business-rates-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Business Rates\" Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
