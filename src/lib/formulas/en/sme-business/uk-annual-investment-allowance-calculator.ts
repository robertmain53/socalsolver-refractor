...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "UK \"Annual Investment Allowance\" (AIA) Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/uk-annual-investment-allowance-calculator",
  slug: "sme-&-business/uk-annual-investment-allowance-calculator",
  ...
  faq: [
    { q: "How do I use the UK \"Annual Investment Allowance\" (AIA) Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
