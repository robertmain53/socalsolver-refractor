...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"Emergency Business Account\" (CEBA) Loan Repayment Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/canada-ceba-loan-repayment-calculator",
  slug: "sme-&-business/canada-ceba-loan-repayment-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"Emergency Business Account\" (CEBA) Loan Repayment Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
