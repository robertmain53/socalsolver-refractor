...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"S-Corp vs. C-Corp\" Tax Comparison Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/us-s-corp-c-corp-tax-calculator",
  slug: "sme-&-business/us-s-corp-c-corp-tax-calculator",
  ...
  faq: [
    { q: "How do I use the US \"S-Corp vs. C-Corp\" Tax Comparison Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
