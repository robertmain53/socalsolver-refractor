...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Customer Lifetime Value (CLV) to \"Customer Acquisition Cost\" (CAC) Ratio Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/customer-lifetime-value-customer-calculator",
  slug: "sme-&-business/customer-lifetime-value-customer-calculator",
  ...
  faq: [
    { q: "How do I use the Customer Lifetime Value (CLV) to \"Customer Acquisition Cost\" (CAC) Ratio Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
