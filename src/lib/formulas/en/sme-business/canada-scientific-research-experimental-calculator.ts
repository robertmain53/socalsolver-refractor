...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"Scientific Research & Experimental Development\" (SR&ED) Tax Incentive Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/canada-scientific-research-experimental-calculator",
  slug: "sme-&-business/canada-scientific-research-experimental-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"Scientific Research & Experimental Development\" (SR&ED) Tax Incentive Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
