...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Monthly Recurring Revenue (MRR) & \"Annual Recurring Revenue\" (ARR) Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/monthly-recurring-revenue-annual-calculator",
  slug: "sme-&-business/monthly-recurring-revenue-annual-calculator",
  ...
  faq: [
    { q: "How do I use the Monthly Recurring Revenue (MRR) & \"Annual Recurring Revenue\" (ARR) Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
