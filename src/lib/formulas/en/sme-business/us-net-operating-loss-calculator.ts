...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Net Operating Loss\" (NOL) Carryforward Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/us-net-operating-loss-calculator",
  slug: "sme-&-business/us-net-operating-loss-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Net Operating Loss\" (NOL) Carryforward Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
