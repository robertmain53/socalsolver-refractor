...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "SaaS Churn Rate Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/saas-churn-rate-calculator",
  slug: "sme-&-business/saas-churn-rate-calculator",
  ...
  faq: [
    { q: "How do I use the SaaS Churn Rate Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
