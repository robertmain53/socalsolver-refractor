...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Paycheck Protection Program\" (PPP) Loan Forgiveness Calculator (historical)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/us-ppp-loan-forgiveness-calculator",
  slug: "sme-&-business/us-ppp-loan-forgiveness-calculator",
  ...
  faq: [
    { q: "How do I use the US \"Paycheck Protection Program\" (PPP) Loan Forgiveness Calculator (historical) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
