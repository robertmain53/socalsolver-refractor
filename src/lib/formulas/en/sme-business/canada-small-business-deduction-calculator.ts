...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"Small Business Deduction\" (SBD) Calculator"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/canada-small-business-deduction-calculator",
  slug: "sme-&-business/canada-small-business-deduction-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"Small Business Deduction\" (SBD) Calculator calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
