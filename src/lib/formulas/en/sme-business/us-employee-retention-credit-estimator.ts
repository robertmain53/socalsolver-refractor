...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "US \"Employee Retention Credit\" (ERC) Estimator (historical)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/us-employee-retention-credit-estimator",
  slug: "sme-&-business/us-employee-retention-credit-estimator",
  ...
  faq: [
    { q: "How do I use the US \"Employee Retention Credit\" (ERC) Estimator (historical) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
