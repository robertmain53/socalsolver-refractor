...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Canada \"Wage Subsidy\" (CEWS) Calculator (historical)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "en:sme-&-business/canada-wage-subsidy-calculator",
  slug: "sme-&-business/canada-wage-subsidy-calculator",
  ...
  faq: [
    { q: "How do I use the Canada \"Wage Subsidy\" (CEWS) Calculator (historical) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
