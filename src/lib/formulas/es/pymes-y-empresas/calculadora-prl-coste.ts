...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Prevención de Riesgos Laborales\" (PRL) - coste de adaptación"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:pymes-y-empresas/calculadora-prl-coste",
  slug: "pymes-y-empresas/calculadora-prl-coste",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Prevención de Riesgos Laborales\" (PRL) - coste de adaptación calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
