...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Prestación por Maternidad/Paternidad"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:pymes-y-empresas/calculadora-prestacion-maternidad",
  slug: "pymes-y-empresas/calculadora-prestacion-maternidad",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Prestación por Maternidad/Paternidad calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
