...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Concurso de Acreedores\" (simplificado)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:pymes-y-empresas/calculadora-concurso-acreedores",
  slug: "pymes-y-empresas/calculadora-concurso-acreedores",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Concurso de Acreedores\" (simplificado) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
