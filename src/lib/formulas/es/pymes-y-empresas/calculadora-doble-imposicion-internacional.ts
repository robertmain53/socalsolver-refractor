...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Doble Imposición\" internacional"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:pymes-y-empresas/calculadora-doble-imposicion-internacional",
  slug: "pymes-y-empresas/calculadora-doble-imposicion-internacional",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Doble Imposición\" internacional calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
