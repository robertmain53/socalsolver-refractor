...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Impuesto de Sociedades\" para Entidades de Tenencia de Valores Extranjeros (ETVE)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:pymes-y-empresas/calculadora-impuesto-sociedades-etve",
  slug: "pymes-y-empresas/calculadora-impuesto-sociedades-etve",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Impuesto de Sociedades\" para Entidades de Tenencia de Valores Extranjeros (ETVE) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
