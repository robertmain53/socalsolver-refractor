...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de una Residencia de Estudiantes vs. Piso Compartido"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:educacion-y-universidad/calculadora-coste-residencia-estudiantes",
  slug: "educacion-y-universidad/calculadora-coste-residencia-estudiantes",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de una Residencia de Estudiantes vs. Piso Compartido calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
