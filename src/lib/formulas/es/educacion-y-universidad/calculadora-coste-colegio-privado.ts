...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de un Colegio Privado/Concertado"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:educacion-y-universidad/calculadora-coste-colegio-privado",
  slug: "educacion-y-universidad/calculadora-coste-colegio-privado",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de un Colegio Privado/Concertado calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
