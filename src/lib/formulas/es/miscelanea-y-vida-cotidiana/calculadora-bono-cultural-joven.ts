...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Bono Cultural Joven\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-bono-cultural-joven",
  slug: "miscelánea-y-vida-cotidiana/calculadora-bono-cultural-joven",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Bono Cultural Joven\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
