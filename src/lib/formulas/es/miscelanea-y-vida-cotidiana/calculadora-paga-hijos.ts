...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Paga\" Semanal/Mensual para los hijos"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-paga-hijos",
  slug: "miscelánea-y-vida-cotidiana/calculadora-paga-hijos",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Paga\" Semanal/Mensual para los hijos calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
