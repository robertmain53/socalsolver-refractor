...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Jubilación Activa\" (compatibilizar pensión y trabajo)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-jubilacion-activa",
  slug: "miscelánea-y-vida-cotidiana/calculadora-jubilacion-activa",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Jubilación Activa\" (compatibilizar pensión y trabajo) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
