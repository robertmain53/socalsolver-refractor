...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Menú del Día\" (coste medio por ciudad)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-menu-del-dia",
  slug: "miscelánea-y-vida-cotidiana/calculadora-menu-del-dia",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Menú del Día\" (coste medio por ciudad) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
