...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de los \"Años Cotizados\" a la Seguridad Social (informe de vida laboral)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-anos-cotizados",
  slug: "miscelánea-y-vida-cotidiana/calculadora-anos-cotizados",
  ...
  faq: [
    { q: "How do I use the Calculadora de los \"Años Cotizados\" a la Seguridad Social (informe de vida laboral) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
