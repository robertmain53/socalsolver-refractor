...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de un \"Día de Playa\" (parking, sombrilla, comida)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-coste-dia-playa",
  slug: "miscelánea-y-vida-cotidiana/calculadora-coste-dia-playa",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de un \"Día de Playa\" (parking, sombrilla, comida) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
