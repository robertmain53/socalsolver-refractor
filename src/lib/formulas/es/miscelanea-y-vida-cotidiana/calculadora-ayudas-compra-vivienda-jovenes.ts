...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de las \"Ayudas para la Compra de Vivienda\" para jóvenes"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-ayudas-compra-vivienda-jovenes",
  slug: "miscelánea-y-vida-cotidiana/calculadora-ayudas-compra-vivienda-jovenes",
  ...
  faq: [
    { q: "How do I use the Calculadora de las \"Ayudas para la Compra de Vivienda\" para jóvenes calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
