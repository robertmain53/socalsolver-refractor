...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Incapacitación Judicial\" (ahora \"medidas de apoyo a personas con discapacidad\")"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-incapacitacion-judicial",
  slug: "miscelánea-y-vida-cotidiana/calculadora-incapacitacion-judicial",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Incapacitación Judicial\" (ahora \"medidas de apoyo a personas con discapacidad\") calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
