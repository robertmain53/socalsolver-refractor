...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Lotería de Navidad\" (probabilidad y reparto de premios)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-loteria-navidad",
  slug: "miscelánea-y-vida-cotidiana/calculadora-loteria-navidad",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Lotería de Navidad\" (probabilidad y reparto de premios) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
