...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de una \"Guardería Canina\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-coste-guarderia-canina",
  slug: "miscelánea-y-vida-cotidiana/calculadora-coste-guarderia-canina",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de una \"Guardería Canina\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
