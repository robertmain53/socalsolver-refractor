...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de las \"Ayudas por Desempleo\" para mayores de 52 años"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:miscelánea-y-vida-cotidiana/calculadora-ayudas-desempleo-mayores-52",
  slug: "miscelánea-y-vida-cotidiana/calculadora-ayudas-desempleo-mayores-52",
  ...
  faq: [
    { q: "How do I use the Calculadora de las \"Ayudas por Desempleo\" para mayores de 52 años calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
