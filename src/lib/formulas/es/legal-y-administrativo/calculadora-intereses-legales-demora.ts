...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de los Intereses Legales y de Demora"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:legal-y-administrativo/calculadora-intereses-legales-demora",
  slug: "legal-y-administrativo/calculadora-intereses-legales-demora",
  ...
  faq: [
    { q: "How do I use the Calculadora de los Intereses Legales y de Demora calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
