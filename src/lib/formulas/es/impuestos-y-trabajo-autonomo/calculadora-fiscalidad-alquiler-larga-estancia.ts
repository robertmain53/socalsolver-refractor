...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Fiscalidad del Alquiler de Larga Estancia (con reducción del 60%)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-fiscalidad-alquiler-larga-estancia",
  slug: "impuestos-y-trabajo-autónomo/calculadora-fiscalidad-alquiler-larga-estancia",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Fiscalidad del Alquiler de Larga Estancia (con reducción del 60%) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
