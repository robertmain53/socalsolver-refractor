...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de Retenciones IRPF para Facturas Profesionales"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-retencion-irpf-facturas",
  slug: "impuestos-y-trabajo-autónomo/calculadora-retencion-irpf-facturas",
  ...
  faq: [
    { q: "How do I use the Calculadora de Retenciones IRPF para Facturas Profesionales calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
