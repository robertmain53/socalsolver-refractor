...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de Gastos Deducibles para Autónomos"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-gastos-deducibles-autonomos",
  slug: "impuestos-y-trabajo-autónomo/calculadora-gastos-deducibles-autonomos",
  ...
  faq: [
    { q: "How do I use the Calculadora de Gastos Deducibles para Autónomos calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
