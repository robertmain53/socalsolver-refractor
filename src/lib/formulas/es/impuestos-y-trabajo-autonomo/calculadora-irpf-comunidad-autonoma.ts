...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de IRPF por Comunidad Autónoma"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-irpf-comunidad-autonoma",
  slug: "impuestos-y-trabajo-autónomo/calculadora-irpf-comunidad-autonoma",
  ...
  faq: [
    { q: "How do I use the Calculadora de IRPF por Comunidad Autónoma calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
