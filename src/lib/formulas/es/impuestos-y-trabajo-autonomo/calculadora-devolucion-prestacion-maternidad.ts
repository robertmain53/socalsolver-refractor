...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Devolución de la Prestación por Maternidad/Paternidad del IRPF"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-devolucion-prestacion-maternidad",
  slug: "impuestos-y-trabajo-autónomo/calculadora-devolucion-prestacion-maternidad",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Devolución de la Prestación por Maternidad/Paternidad del IRPF calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
