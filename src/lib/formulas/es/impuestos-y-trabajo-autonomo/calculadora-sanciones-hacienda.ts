...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de las Sanciones de Hacienda (reducciones por pronto pago)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-sanciones-hacienda",
  slug: "impuestos-y-trabajo-autónomo/calculadora-sanciones-hacienda",
  ...
  faq: [
    { q: "How do I use the Calculadora de las Sanciones de Hacienda (reducciones por pronto pago) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
