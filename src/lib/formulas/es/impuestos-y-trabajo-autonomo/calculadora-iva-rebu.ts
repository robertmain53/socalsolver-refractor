...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del IVA en Régimen Especial de Bienes Usados (REBU)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-iva-rebu",
  slug: "impuestos-y-trabajo-autónomo/calculadora-iva-rebu",
  ...
  faq: [
    { q: "How do I use the Calculadora del IVA en Régimen Especial de Bienes Usados (REBU) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
