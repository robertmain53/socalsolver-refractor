...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de los Intereses de Demora de Hacienda"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-intereses-demora-hacienda",
  slug: "impuestos-y-trabajo-autónomo/calculadora-intereses-demora-hacienda",
  ...
  faq: [
    { q: "How do I use the Calculadora de los Intereses de Demora de Hacienda calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
