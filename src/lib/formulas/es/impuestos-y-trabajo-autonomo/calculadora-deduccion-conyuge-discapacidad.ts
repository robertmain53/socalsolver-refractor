...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Deducción por Cónyuge con Discapacidad a Cargo"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-deduccion-conyuge-discapacidad",
  slug: "impuestos-y-trabajo-autónomo/calculadora-deduccion-conyuge-discapacidad",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Deducción por Cónyuge con Discapacidad a Cargo calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
