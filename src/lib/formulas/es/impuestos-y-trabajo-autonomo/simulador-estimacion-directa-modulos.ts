...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Simulador Conveniencia: Estimación Directa vs. Módulos"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/simulador-estimacion-directa-modulos",
  slug: "impuestos-y-trabajo-autónomo/simulador-estimacion-directa-modulos",
  ...
  faq: [
    { q: "How do I use the Simulador Conveniencia: Estimación Directa vs. Módulos calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
