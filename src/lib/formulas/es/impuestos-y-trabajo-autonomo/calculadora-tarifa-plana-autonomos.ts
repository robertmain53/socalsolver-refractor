...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la \"Tarifa Plana\" para nuevos autónomos"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-tarifa-plana-autonomos",
  slug: "impuestos-y-trabajo-autónomo/calculadora-tarifa-plana-autonomos",
  ...
  faq: [
    { q: "How do I use the Calculadora de la \"Tarifa Plana\" para nuevos autónomos calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
