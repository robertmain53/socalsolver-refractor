...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora Cuota de Autónomos 2025 (per tramos de ingresos reales)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:impuestos-y-trabajo-autónomo/calculadora-cuota-autonomos-2025",
  slug: "impuestos-y-trabajo-autónomo/calculadora-cuota-autonomos-2025",
  ...
  faq: [
    { q: "How do I use the Calculadora Cuota de Autónomos 2025 (per tramos de ingresos reales) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
