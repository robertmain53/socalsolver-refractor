...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de las Lentillas vs. Gafas"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:salud-y-bienestar/calculadora-coste-lentillas-vs-gafas",
  slug: "salud-y-bienestar/calculadora-coste-lentillas-vs-gafas",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de las Lentillas vs. Gafas calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
