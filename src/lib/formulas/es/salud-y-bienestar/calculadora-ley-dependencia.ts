...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Ley de Dependencia (ayudas)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:salud-y-bienestar/calculadora-ley-dependencia",
  slug: "salud-y-bienestar/calculadora-ley-dependencia",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Ley de Dependencia (ayudas) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
