...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de la Donación de Sangre (cuándo puedes volver a donar)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:salud-y-bienestar/calculadora-donacion-sangre",
  slug: "salud-y-bienestar/calculadora-donacion-sangre",
  ...
  faq: [
    { q: "How do I use the Calculadora de la Donación de Sangre (cuándo puedes volver a donar) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
