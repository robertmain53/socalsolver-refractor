...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Plan Renove\" de Electrodomésticos por C.A."
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:bienes-raices-y-vivienda/calculadora-plan-renove-electrodomesticos",
  slug: "bienes-raices-y-vivienda/calculadora-plan-renove-electrodomesticos",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Plan Renove\" de Electrodomésticos por C.A. calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
