...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Usufructo\" vs. \"Nuda Propiedad\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:bienes-raices-y-vivienda/calculadora-usufructo-nuda-propiedad",
  slug: "bienes-raices-y-vivienda/calculadora-usufructo-nuda-propiedad",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Usufructo\" vs. \"Nuda Propiedad\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
