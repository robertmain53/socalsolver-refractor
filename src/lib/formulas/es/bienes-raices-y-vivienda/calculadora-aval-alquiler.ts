...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del \"Aval\" Bancario para Alquiler"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:bienes-raices-y-vivienda/calculadora-aval-alquiler",
  slug: "bienes-raices-y-vivienda/calculadora-aval-alquiler",
  ...
  faq: [
    { q: "How do I use the Calculadora del \"Aval\" Bancario para Alquiler calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
