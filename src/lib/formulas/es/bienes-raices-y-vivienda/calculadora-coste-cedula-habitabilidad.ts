...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de una \"Cédula de Habitabilidad\" por C.A."
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:bienes-raices-y-vivienda/calculadora-coste-cedula-habitabilidad",
  slug: "bienes-raices-y-vivienda/calculadora-coste-cedula-habitabilidad",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de una \"Cédula de Habitabilidad\" por C.A. calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
