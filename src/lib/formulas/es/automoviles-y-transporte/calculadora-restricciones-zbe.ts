...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora de las Restricciones de Tráfico por ZBE (Zonas de Bajas Emisiones)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:automóviles-y-transporte/calculadora-restricciones-zbe",
  slug: "automóviles-y-transporte/calculadora-restricciones-zbe",
  ...
  faq: [
    { q: "How do I use the Calculadora de las Restricciones de Tráfico por ZBE (Zonas de Bajas Emisiones) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
