...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de un \"Alquiler de Coche\" (con/sin franquicia)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:automóviles-y-transporte/calculadora-coste-alquiler-coche",
  slug: "automóviles-y-transporte/calculadora-coste-alquiler-coche",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de un \"Alquiler de Coche\" (con/sin franquicia) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
