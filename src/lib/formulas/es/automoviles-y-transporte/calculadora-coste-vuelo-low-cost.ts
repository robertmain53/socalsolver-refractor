...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de un \"Vuelo Low Cost\" (con extras)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:automóviles-y-transporte/calculadora-coste-vuelo-low-cost",
  slug: "automóviles-y-transporte/calculadora-coste-vuelo-low-cost",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de un \"Vuelo Low Cost\" (con extras) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
