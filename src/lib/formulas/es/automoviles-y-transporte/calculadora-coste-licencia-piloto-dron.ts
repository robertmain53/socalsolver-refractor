...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculadora del Coste de una \"Licencia de Piloto\" de dron"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "es:automóviles-y-transporte/calculadora-coste-licencia-piloto-dron",
  slug: "automóviles-y-transporte/calculadora-coste-licencia-piloto-dron",
  ...
  faq: [
    { q: "How do I use the Calculadora del Coste de una \"Licencia de Piloto\" de dron calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
