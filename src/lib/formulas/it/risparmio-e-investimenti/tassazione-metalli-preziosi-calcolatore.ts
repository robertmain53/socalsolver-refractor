...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Metalli Preziosi (diversi dall'oro)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-metalli-preziosi-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-metalli-preziosi-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Metalli Preziosi (diversi dall'oro) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
