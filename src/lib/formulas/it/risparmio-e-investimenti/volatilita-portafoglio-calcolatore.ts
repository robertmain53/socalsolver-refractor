...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Volatilità di un Titolo/Portafoglio"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/volatilita-portafoglio-calcolatore",
  slug: "risparmio-e-investimenti/volatilita-portafoglio-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Volatilità di un Titolo/Portafoglio calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
