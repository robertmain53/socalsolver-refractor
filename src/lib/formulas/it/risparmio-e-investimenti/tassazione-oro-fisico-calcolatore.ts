...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Oro Fisico da Investimento"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-oro-fisico-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-oro-fisico-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Oro Fisico da Investimento calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
