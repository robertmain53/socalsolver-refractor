...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Auto d'Epoca da Investimento"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-auto-epoca-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-auto-epoca-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Auto d'Epoca da Investimento calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
