...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore PIR (Piani Individuali di Risparmio) - Vantaggi Fiscali"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/pir-calcolatore",
  slug: "risparmio-e-investimenti/pir-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore PIR (Piani Individuali di Risparmio) - Vantaggi Fiscali calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
