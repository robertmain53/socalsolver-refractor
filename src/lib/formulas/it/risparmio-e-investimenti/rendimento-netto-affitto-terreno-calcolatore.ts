...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Rendimento Netto da Affitto di Terreno Agricolo"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/rendimento-netto-affitto-terreno-calcolatore",
  slug: "risparmio-e-investimenti/rendimento-netto-affitto-terreno-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Rendimento Netto da Affitto di Terreno Agricolo calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
