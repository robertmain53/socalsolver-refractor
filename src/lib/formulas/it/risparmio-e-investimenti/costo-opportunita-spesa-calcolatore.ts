...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Opportunità di una Spesa"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/costo-opportunita-spesa-calcolatore",
  slug: "risparmio-e-investimenti/costo-opportunita-spesa-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Opportunità di una Spesa calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
