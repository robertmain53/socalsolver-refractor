...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Beta di un'Azione"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/beta-azione-calcolatore",
  slug: "risparmio-e-investimenti/beta-azione-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Beta di un'Azione calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
