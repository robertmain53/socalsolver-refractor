...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Sortino Ratio di un Portafoglio"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/sortino-ratio-portafoglio-calcolatore",
  slug: "risparmio-e-investimenti/sortino-ratio-portafoglio-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Sortino Ratio di un Portafoglio calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
