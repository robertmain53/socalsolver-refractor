...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per CFD (Contracts for Difference)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-cfd-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-cfd-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per CFD (Contracts for Difference) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
