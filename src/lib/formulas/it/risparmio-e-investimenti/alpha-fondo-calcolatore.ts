...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Alpha di un Fondo di Investimento"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/alpha-fondo-calcolatore",
  slug: "risparmio-e-investimenti/alpha-fondo-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Alpha di un Fondo di Investimento calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
