...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Correlazione tra Asset Finanziari"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/correlazione-asset-calcolatore",
  slug: "risparmio-e-investimenti/correlazione-asset-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Correlazione tra Asset Finanziari calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
