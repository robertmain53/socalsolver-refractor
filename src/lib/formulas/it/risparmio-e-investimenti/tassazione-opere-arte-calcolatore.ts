...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Opere d'Arte e Collezionismo"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-opere-arte-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-opere-arte-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Opere d'Arte e Collezionismo calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
