...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Inflazione Personale (basato sulle proprie spese)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/inflazione-personale-calcolatore",
  slug: "risparmio-e-investimenti/inflazione-personale-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Inflazione Personale (basato sulle proprie spese) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
