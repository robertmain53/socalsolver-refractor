...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Francobolli/Monete da Collezione"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:risparmio-e-investimenti/tassazione-francobolli-monete-calcolatore",
  slug: "risparmio-e-investimenti/tassazione-francobolli-monete-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Francobolli/Monete da Collezione calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
