...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Monopattino Elettrico (acquisto vs. sharing)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:auto-e-trasporti/costo-monopattino-elettrico-calcolatore",
  slug: "auto-e-trasporti/costo-monopattino-elettrico-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Monopattino Elettrico (acquisto vs. sharing) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
