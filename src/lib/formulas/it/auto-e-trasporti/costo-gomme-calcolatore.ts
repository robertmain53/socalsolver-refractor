...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Gomme (estive/invernali/quattro stagioni)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:auto-e-trasporti/costo-gomme-calcolatore",
  slug: "auto-e-trasporti/costo-gomme-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Gomme (estive/invernali/quattro stagioni) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
