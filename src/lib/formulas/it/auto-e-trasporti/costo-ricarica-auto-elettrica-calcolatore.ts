...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Ricarica Auto Elettrica (domestica vs. colonnina pubblica)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:auto-e-trasporti/costo-ricarica-auto-elettrica-calcolatore",
  slug: "auto-e-trasporti/costo-ricarica-auto-elettrica-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Ricarica Auto Elettrica (domestica vs. colonnina pubblica) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
