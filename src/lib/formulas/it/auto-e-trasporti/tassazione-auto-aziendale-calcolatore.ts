...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione Auto Aziendale in Uso Promiscuo (Fringe Benefit)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:auto-e-trasporti/tassazione-auto-aziendale-calcolatore",
  slug: "auto-e-trasporti/tassazione-auto-aziendale-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione Auto Aziendale in Uso Promiscuo (Fringe Benefit) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
