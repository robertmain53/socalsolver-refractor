...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Multa per Eccesso di Velocità (con decurtazione punti)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:auto-e-trasporti/multa-eccesso-velocita-calcolatore",
  slug: "auto-e-trasporti/multa-eccesso-velocita-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Multa per Eccesso di Velocità (con decurtazione punti) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
