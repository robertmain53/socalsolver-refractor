...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Visura Catastale/Ipotecaria"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:legale-e-amministrativo/costo-visura-catastale",
  slug: "legale-e-amministrativo/costo-visura-catastale",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Visura Catastale/Ipotecaria calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
