...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Sanzioni per Violazioni Codice della Strada"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:legale-e-amministrativo/sanzioni-codice-strada",
  slug: "legale-e-amministrativo/sanzioni-codice-strada",
  ...
  faq: [
    { q: "How do I use the Calcolatore Sanzioni per Violazioni Codice della Strada calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
