...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Contributi Minimi vs. Eccedenti per Artigiani/Commercianti"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/contributi-minimi-eccedenti-calcolatore",
  slug: "fisco-e-lavoro-autonomo/contributi-minimi-eccedenti-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Contributi Minimi vs. Eccedenti per Artigiani/Commercianti calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
