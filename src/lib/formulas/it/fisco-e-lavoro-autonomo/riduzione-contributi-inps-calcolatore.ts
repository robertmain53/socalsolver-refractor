...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Riduzione Contributi INPS del 35% per Forfettari"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/riduzione-contributi-inps-calcolatore",
  slug: "fisco-e-lavoro-autonomo/riduzione-contributi-inps-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Riduzione Contributi INPS del 35% per Forfettari calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
