...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore IVIE (Imposta sul valore degli immobili situati all'estero)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/ivie-calcolatore",
  slug: "fisco-e-lavoro-autonomo/ivie-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore IVIE (Imposta sul valore degli immobili situati all'estero) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
