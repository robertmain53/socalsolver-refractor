...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Credito d'Imposta per Ricerca e Sviluppo"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/credito-imposta-rs-calcolatore",
  slug: "fisco-e-lavoro-autonomo/credito-imposta-rs-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Credito d'Imposta per Ricerca e Sviluppo calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
