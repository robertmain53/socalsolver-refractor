...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Società in Accomandita Semplice (SAS)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/tassazione-sas-calcolatore",
  slug: "fisco-e-lavoro-autonomo/tassazione-sas-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Società in Accomandita Semplice (SAS) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
