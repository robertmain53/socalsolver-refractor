...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Sabatini (contributo in conto impianti)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/sabatini-calcolatore",
  slug: "fisco-e-lavoro-autonomo/sabatini-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Sabatini (contributo in conto impianti) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
