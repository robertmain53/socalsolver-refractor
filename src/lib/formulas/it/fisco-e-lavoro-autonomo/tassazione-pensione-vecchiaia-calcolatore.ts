...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Pensione di Vecchiaia/Anticipata"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/tassazione-pensione-vecchiaia-calcolatore",
  slug: "fisco-e-lavoro-autonomo/tassazione-pensione-vecchiaia-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Pensione di Vecchiaia/Anticipata calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
