...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Premi di Produttività (detassazione)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/tassazione-premi-produttivita-calcolatore",
  slug: "fisco-e-lavoro-autonomo/tassazione-premi-produttivita-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Premi di Produttività (detassazione) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
