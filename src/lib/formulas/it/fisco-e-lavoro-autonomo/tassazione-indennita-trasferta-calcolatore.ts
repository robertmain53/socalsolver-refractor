...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Indennità di Trasferta (Italia/Estero)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:fisco-e-lavoro-autonomo/tassazione-indennita-trasferta-calcolatore",
  slug: "fisco-e-lavoro-autonomo/tassazione-indennita-trasferta-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Indennità di Trasferta (Italia/Estero) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
