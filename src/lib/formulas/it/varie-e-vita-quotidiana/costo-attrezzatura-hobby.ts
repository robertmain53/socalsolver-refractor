...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Attrezzatura per Hobby (pesca, pittura, etc.)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:varie-e-vita-quotidiana/costo-attrezzatura-hobby",
  slug: "varie-e-vita-quotidiana/costo-attrezzatura-hobby",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Attrezzatura per Hobby (pesca, pittura, etc.) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
