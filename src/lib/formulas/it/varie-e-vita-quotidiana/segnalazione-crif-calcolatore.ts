...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Segnalazione CRIF (tempi di cancellazione)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:varie-e-vita-quotidiana/segnalazione-crif-calcolatore",
  slug: "varie-e-vita-quotidiana/segnalazione-crif-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Segnalazione CRIF (tempi di cancellazione) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
