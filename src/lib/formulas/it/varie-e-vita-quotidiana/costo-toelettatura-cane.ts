...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Toelettatura Cane"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:varie-e-vita-quotidiana/costo-toelettatura-cane",
  slug: "varie-e-vita-quotidiana/costo-toelettatura-cane",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Toelettatura Cane calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
