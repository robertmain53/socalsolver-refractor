...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo PC da Gaming (componenti)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:varie-e-vita-quotidiana/costo-pc-gaming",
  slug: "varie-e-vita-quotidiana/costo-pc-gaming",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo PC da Gaming (componenti) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
