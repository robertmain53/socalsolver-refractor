...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Quota Iscrizione Partito/Sindacato (con detrazioni)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:varie-e-vita-quotidiana/quota-iscrizione-partito-sindacato-calcolatore",
  slug: "varie-e-vita-quotidiana/quota-iscrizione-partito-sindacato-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Quota Iscrizione Partito/Sindacato (con detrazioni) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
