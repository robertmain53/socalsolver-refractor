...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Calorie Bruciate per Attività Fisica"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:salute-e-benessere/calorie-bruciate",
  slug: "salute-e-benessere/calorie-bruciate",
  ...
  faq: [
    { q: "How do I use the Calcolatore Calorie Bruciate per Attività Fisica calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
