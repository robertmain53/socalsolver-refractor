...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Sedute di Psicoterapia (con Bonus Psicologo)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:salute-e-benessere/costo-psicoterapia",
  slug: "salute-e-benessere/costo-psicoterapia",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Sedute di Psicoterapia (con Bonus Psicologo) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
