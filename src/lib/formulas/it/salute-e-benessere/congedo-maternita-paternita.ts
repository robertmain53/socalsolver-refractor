...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Congedo di Maternità/Paternità"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:salute-e-benessere/congedo-maternita-paternita",
  slug: "salute-e-benessere/congedo-maternita-paternita",
  ...
  faq: [
    { q: "How do I use the Calcolatore Congedo di Maternità/Paternità calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
