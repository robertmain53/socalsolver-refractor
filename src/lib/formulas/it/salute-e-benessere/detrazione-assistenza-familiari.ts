...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Detrazione Spese per Assistenza a Familiari non Autosufficienti"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:salute-e-benessere/detrazione-assistenza-familiari",
  slug: "salute-e-benessere/detrazione-assistenza-familiari",
  ...
  faq: [
    { q: "How do I use the Calcolatore Detrazione Spese per Assistenza a Familiari non Autosufficienti calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
