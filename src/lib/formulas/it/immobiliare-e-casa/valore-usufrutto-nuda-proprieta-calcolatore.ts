...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Valore Usufrutto vs. Nuda Proprietà"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/valore-usufrutto-nuda-proprieta-calcolatore",
  slug: "immobiliare-e-casa/valore-usufrutto-nuda-proprieta-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Valore Usufrutto vs. Nuda Proprietà calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
