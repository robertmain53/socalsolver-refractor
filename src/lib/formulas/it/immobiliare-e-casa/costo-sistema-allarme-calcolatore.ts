...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Sistema di Allarme"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-sistema-allarme-calcolatore",
  slug: "immobiliare-e-casa/costo-sistema-allarme-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Sistema di Allarme calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
