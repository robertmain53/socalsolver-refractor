...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Allaccio Utenze (acqua, luce, gas)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-allaccio-utenze-calcolatore",
  slug: "immobiliare-e-casa/costo-allaccio-utenze-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Allaccio Utenze (acqua, luce, gas) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
