...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Realizzazione Campo da Tennis/Padel"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-campo-tennis-padel-calcolatore",
  slug: "immobiliare-e-casa/costo-campo-tennis-padel-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Realizzazione Campo da Tennis/Padel calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
