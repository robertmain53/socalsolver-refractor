...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Indennità di Occupazione Senza Titolo"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/indennita-occupazione-senza-titolo-calcolatore",
  slug: "immobiliare-e-casa/indennita-occupazione-senza-titolo-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Indennità di Occupazione Senza Titolo calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
