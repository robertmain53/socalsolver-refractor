...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione per Risoluzione Anticipata Contratto di Locazione"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/tassazione-risoluzione-contratto-locazione-calcolatore",
  slug: "immobiliare-e-casa/tassazione-risoluzione-contratto-locazione-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione per Risoluzione Anticipata Contratto di Locazione calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
