...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Tassazione Comodato d'Uso Gratuito"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/tassazione-comodato-uso-calcolatore",
  slug: "immobiliare-e-casa/tassazione-comodato-uso-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Tassazione Comodato d'Uso Gratuito calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
