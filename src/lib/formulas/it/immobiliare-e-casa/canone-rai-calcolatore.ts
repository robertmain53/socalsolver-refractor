...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Canone RAI (storico, in bolletta)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/canone-rai-calcolatore",
  slug: "immobiliare-e-casa/canone-rai-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Canone RAI (storico, in bolletta) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
