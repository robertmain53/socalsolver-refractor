...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Sismabonus (detrazioni varie)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/sismabonus-calcolatore",
  slug: "immobiliare-e-casa/sismabonus-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Sismabonus (detrazioni varie) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
