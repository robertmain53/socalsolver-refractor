...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Realizzazione Pozzo Artesiano"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-pozzo-artesiano-calcolatore",
  slug: "immobiliare-e-casa/costo-pozzo-artesiano-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Realizzazione Pozzo Artesiano calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
