...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Voltura vs. Subentro Utenze"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/voltura-subentro-utenze-calcolatore",
  slug: "immobiliare-e-casa/voltura-subentro-utenze-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Voltura vs. Subentro Utenze calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
