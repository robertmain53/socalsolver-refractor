...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Realizzazione Piscina"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-realizzazione-piscina-calcolatore",
  slug: "immobiliare-e-casa/costo-realizzazione-piscina-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Realizzazione Piscina calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
