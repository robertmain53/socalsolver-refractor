...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Realizzazione Impianto di Irrigazione"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-impianto-irrigazione-calcolatore",
  slug: "immobiliare-e-casa/costo-impianto-irrigazione-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Realizzazione Impianto di Irrigazione calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
