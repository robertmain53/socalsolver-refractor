...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Oneri di Urbanizzazione per Nuova Costruzione"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/oneri-urbanizzazione-calcolatore",
  slug: "immobiliare-e-casa/oneri-urbanizzazione-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Oneri di Urbanizzazione per Nuova Costruzione calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
