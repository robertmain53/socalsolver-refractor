...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Manutenzione Caldaia"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/costo-manutenzione-caldaia-calcolatore",
  slug: "immobiliare-e-casa/costo-manutenzione-caldaia-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Manutenzione Caldaia calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
