...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Spese Straordinarie Condominio (ripartizione proprietario/inquilino)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/spese-straordinarie-condominio-calcolatore",
  slug: "immobiliare-e-casa/spese-straordinarie-condominio-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Spese Straordinarie Condominio (ripartizione proprietario/inquilino) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
