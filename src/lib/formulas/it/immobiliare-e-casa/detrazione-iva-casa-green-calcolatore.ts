...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Detrazione IVA per Acquisto Casa Green"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:immobiliare-e-casa/detrazione-iva-casa-green-calcolatore",
  slug: "immobiliare-e-casa/detrazione-iva-casa-green-calcolatore",
  ...
  faq: [
    { q: "How do I use the Calcolatore Detrazione IVA per Acquisto Casa Green calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
