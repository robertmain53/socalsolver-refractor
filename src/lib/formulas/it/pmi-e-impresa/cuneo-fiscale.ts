...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calcolatore Costo Totale Dipendente (Cuneo Fiscale)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "it:pmi-e-impresa/cuneo-fiscale",
  slug: "pmi-e-impresa/cuneo-fiscale",
  ...
  faq: [
    { q: "How do I use the Calcolatore Costo Totale Dipendente (Cuneo Fiscale) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
