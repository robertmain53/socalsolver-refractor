...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Budget pour un Festival de Musique (billet, transport, logement)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-budget-festival-musique",
  slug: "loisirs-et-temps-libre/calculateur-budget-festival-musique",
  ...
  faq: [
    { q: "How do I use the Calculateur du Budget pour un Festival de Musique (billet, transport, logement) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
