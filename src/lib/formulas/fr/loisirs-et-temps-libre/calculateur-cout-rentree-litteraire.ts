...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Coût de la Rentrée Littéraire"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-cout-rentree-litteraire",
  slug: "loisirs-et-temps-libre/calculateur-cout-rentree-litteraire",
  ...
  faq: [
    { q: "How do I use the Calculateur du Coût de la Rentrée Littéraire calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
