...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Coût d'un Instrument de Musique (achat vs. location)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-cout-instrument-musique",
  slug: "loisirs-et-temps-libre/calculateur-cout-instrument-musique",
  ...
  faq: [
    { q: "How do I use the Calculateur du Coût d'un Instrument de Musique (achat vs. location) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
