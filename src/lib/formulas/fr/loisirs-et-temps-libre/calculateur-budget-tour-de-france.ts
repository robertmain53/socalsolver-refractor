...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Budget pour le Tour de France (spectateur)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-budget-tour-de-france",
  slug: "loisirs-et-temps-libre/calculateur-budget-tour-de-france",
  ...
  faq: [
    { q: "How do I use the Calculateur du Budget pour le Tour de France (spectateur) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
