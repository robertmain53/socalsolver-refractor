...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Coût d'une Licence Sportive"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-cout-licence-sportive",
  slug: "loisirs-et-temps-libre/calculateur-cout-licence-sportive",
  ...
  faq: [
    { q: "How do I use the Calculateur du Coût d'une Licence Sportive calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
