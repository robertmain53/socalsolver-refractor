...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Coût d'un Abonnement à une Salle de Sport"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:loisirs-et-temps-libre/calculateur-cout-salle-sport",
  slug: "loisirs-et-temps-libre/calculateur-cout-salle-sport",
  ...
  faq: [
    { q: "How do I use the Calculateur du Coût d'un Abonnement à une Salle de Sport calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
