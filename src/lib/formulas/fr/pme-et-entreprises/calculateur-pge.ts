...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Prêt Garanti par l'État\" (PGE) - historique"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-pge",
  slug: "pme-et-entreprises/calculateur-pge",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Prêt Garanti par l'État\" (PGE) - historique calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
