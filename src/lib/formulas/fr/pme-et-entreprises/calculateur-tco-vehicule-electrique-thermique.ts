...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Coût Total de Possession\" (TCO) d'un véhicule électrique vs. thermique"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-tco-vehicule-electrique-thermique",
  slug: "pme-et-entreprises/calculateur-tco-vehicule-electrique-thermique",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Coût Total de Possession\" (TCO) d'un véhicule électrique vs. thermique calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
