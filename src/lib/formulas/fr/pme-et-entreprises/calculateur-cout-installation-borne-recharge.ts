...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Coût d'Installation\" d'une borne de recharge"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-cout-installation-borne-recharge",
  slug: "pme-et-entreprises/calculateur-cout-installation-borne-recharge",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Coût d'Installation\" d'une borne de recharge calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
