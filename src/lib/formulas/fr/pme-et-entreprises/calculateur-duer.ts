...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Document Unique d'Évaluation des Risques\" (DUER) - coût"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-duer",
  slug: "pme-et-entreprises/calculateur-duer",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Document Unique d'Évaluation des Risques\" (DUER) - coût calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
