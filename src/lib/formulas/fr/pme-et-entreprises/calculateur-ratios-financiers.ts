...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur des \"Ratios Financiers\" (liquidité, solvabilité, rentabilité)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-ratios-financiers",
  slug: "pme-et-entreprises/calculateur-ratios-financiers",
  ...
  faq: [
    { q: "How do I use the Calculateur des \"Ratios Financiers\" (liquidité, solvabilité, rentabilité) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
