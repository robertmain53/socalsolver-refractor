...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Leasing\" (LOA) vs. \"Crédit Classique\" vs. \"LLD\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-leasing-loa-vs-credit-lld",
  slug: "pme-et-entreprises/calculateur-leasing-loa-vs-credit-lld",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Leasing\" (LOA) vs. \"Crédit Classique\" vs. \"LLD\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
