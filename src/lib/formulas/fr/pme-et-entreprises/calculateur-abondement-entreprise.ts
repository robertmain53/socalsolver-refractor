...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de l'\"Abondement\" de l'entreprise sur PEE/PERCO"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-abondement-entreprise",
  slug: "pme-et-entreprises/calculateur-abondement-entreprise",
  ...
  faq: [
    { q: "How do I use the Calculateur de l'\"Abondement\" de l'entreprise sur PEE/PERCO calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
