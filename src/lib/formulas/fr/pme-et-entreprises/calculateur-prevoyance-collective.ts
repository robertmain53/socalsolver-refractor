...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Prévoyance Collective\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:pme-et-entreprises/calculateur-prevoyance-collective",
  slug: "pme-et-entreprises/calculateur-prevoyance-collective",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Prévoyance Collective\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
