...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du Budget pour un Potager Familial"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:agriculture-et-alimentation/calculateur-budget-potager",
  slug: "agriculture-et-alimentation/calculateur-budget-potager",
  ...
  faq: [
    { q: "How do I use the Calculateur du Budget pour un Potager Familial calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
