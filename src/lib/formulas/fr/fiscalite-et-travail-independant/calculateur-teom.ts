...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Taxe d'Enlèvement des Ordures Ménagères\" (TEOM)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-teom",
  slug: "fiscalite-et-travail-independant/calculateur-teom",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Taxe d'Enlèvement des Ordures Ménagères\" (TEOM) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
