...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Taxe de 3%\" sur les immeubles détenus par des entités étrangères"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-taxe-3-pourcent-immeubles-etrangers",
  slug: "fiscalite-et-travail-independant/calculateur-taxe-3-pourcent-immeubles-etrangers",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Taxe de 3%\" sur les immeubles détenus par des entités étrangères calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
