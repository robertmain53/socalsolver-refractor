...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la fiscalité de l'Assurance-Vie (rachat avant/après 8 ans)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-fiscalite-assurance-vie",
  slug: "fiscalite-et-travail-independant/calculateur-fiscalite-assurance-vie",
  ...
  faq: [
    { q: "How do I use the Calculateur de la fiscalité de l'Assurance-Vie (rachat avant/après 8 ans) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
