...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Taxe PUMa\" (Protection Universelle Maladie) pour rentiers"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-taxe-puma",
  slug: "fiscalite-et-travail-independant/calculateur-taxe-puma",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Taxe PUMa\" (Protection Universelle Maladie) pour rentiers calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
