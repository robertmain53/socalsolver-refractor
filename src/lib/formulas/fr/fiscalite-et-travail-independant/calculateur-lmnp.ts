...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du statut \"Loueur en Meublé Non Professionnel\" (LMNP) - régime réel vs. micro-BIC"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-lmnp",
  slug: "fiscalite-et-travail-independant/calculateur-lmnp",
  ...
  faq: [
    { q: "How do I use the Calculateur du statut \"Loueur en Meublé Non Professionnel\" (LMNP) - régime réel vs. micro-BIC calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
