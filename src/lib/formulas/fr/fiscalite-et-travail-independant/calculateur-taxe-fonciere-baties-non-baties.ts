...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Taxe Foncière sur les Propriétés Bâties/Non Bâties\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-taxe-fonciere-baties-non-baties",
  slug: "fiscalite-et-travail-independant/calculateur-taxe-fonciere-baties-non-baties",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Taxe Foncière sur les Propriétés Bâties/Non Bâties\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
