...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de Cotisations Sociales URSSAF (indépendant/profession libérale)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-cotisations-urssaf",
  slug: "fiscalite-et-travail-independant/calculateur-cotisations-urssaf",
  ...
  faq: [
    { q: "How do I use the Calculateur de Cotisations Sociales URSSAF (indépendant/profession libérale) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
