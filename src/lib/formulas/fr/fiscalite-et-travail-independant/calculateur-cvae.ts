...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Cotisation sur la Valeur Ajoutée des Entreprises\" (CVAE)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-cvae",
  slug: "fiscalite-et-travail-independant/calculateur-cvae",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Cotisation sur la Valeur Ajoutée des Entreprises\" (CVAE) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
