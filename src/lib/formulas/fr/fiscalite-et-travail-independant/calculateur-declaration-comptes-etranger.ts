...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Déclaration des comptes à l'étranger\" (formulaire 3916)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-declaration-comptes-etranger",
  slug: "fiscalite-et-travail-independant/calculateur-declaration-comptes-etranger",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Déclaration des comptes à l'étranger\" (formulaire 3916) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
