...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la loi \"Pinel\" / \"Pinel+\" (réduction d'impôt)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-loi-pinel",
  slug: "fiscalite-et-travail-independant/calculateur-loi-pinel",
  ...
  faq: [
    { q: "How do I use the Calculateur de la loi \"Pinel\" / \"Pinel+\" (réduction d'impôt) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
