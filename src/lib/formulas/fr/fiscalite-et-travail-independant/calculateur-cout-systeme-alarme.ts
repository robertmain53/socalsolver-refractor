...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Coût d'un Système d'Alarme\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-cout-systeme-alarme",
  slug: "fiscalite-et-travail-independant/calculateur-cout-systeme-alarme",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Coût d'un Système d'Alarme\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
