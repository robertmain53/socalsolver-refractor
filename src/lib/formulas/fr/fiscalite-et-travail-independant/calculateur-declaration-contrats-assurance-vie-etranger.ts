...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Déclaration des contrats d'assurance-vie à l'étranger\""
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-declaration-contrats-assurance-vie-etranger",
  slug: "fiscalite-et-travail-independant/calculateur-declaration-contrats-assurance-vie-etranger",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Déclaration des contrats d'assurance-vie à l'étranger\" calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
