...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur de la \"Réduction d'impôt pour souscription au capital de PME\" (Madelin)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-reduction-impot-pme-madelin",
  slug: "fiscalite-et-travail-independant/calculateur-reduction-impot-pme-madelin",
  ...
  faq: [
    { q: "How do I use the Calculateur de la \"Réduction d'impôt pour souscription au capital de PME\" (Madelin) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
