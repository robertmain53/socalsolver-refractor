...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Simulateur de Revenu: Micro-entrepreneur vs. Régime Réel"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/simulateur-revenu-micro-vs-reel",
  slug: "fiscalite-et-travail-independant/simulateur-revenu-micro-vs-reel",
  ...
  faq: [
    { q: "How do I use the Simulateur de Revenu: Micro-entrepreneur vs. Régime Réel calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
