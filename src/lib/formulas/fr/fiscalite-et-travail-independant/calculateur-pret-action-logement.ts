...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Prêt Action Logement\" (ex 1% Logement)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-pret-action-logement",
  slug: "fiscalite-et-travail-independant/calculateur-pret-action-logement",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Prêt Action Logement\" (ex 1% Logement) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
