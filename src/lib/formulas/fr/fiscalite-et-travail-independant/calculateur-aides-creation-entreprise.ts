...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur des aides à la création d'entreprise (ARCE vs. maintien ARE)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-aides-creation-entreprise",
  slug: "fiscalite-et-travail-independant/calculateur-aides-creation-entreprise",
  ...
  faq: [
    { q: "How do I use the Calculateur des aides à la création d'entreprise (ARCE vs. maintien ARE) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
