...
export const formula: Formula = (inputs) => {
  // TODO: implement real formula for "Calculateur du \"Coût d'un Système de Chauffage\" (pompe à chaleur, chaudière)"
  const v = Number(inputs.value ?? 0);
  return { result: v };
};

export const meta: CalculatorMeta = {
  key: "fr:fiscalite-et-travail-independant/calculateur-cout-systeme-chauffage",
  slug: "fiscalite-et-travail-independant/calculateur-cout-systeme-chauffage",
  ...
  faq: [
    { q: "How do I use the Calculateur du \"Coût d'un Système de Chauffage\" (pompe à chaleur, chaudière) calculator?", aMd: 'Enter inputs on the left and review the computed results on the right. The **Formulas** section explains the math used.' },
